...
<script lang="ts" setup name="Home1">
import Header from '../components/Student/Header.vue';
import UserSection from '../components/Student/UserSection.vue';
import CoursesSection from '../components/Student/CoursesSection.vue'
