  ...
  <div class="big">
    <div class="user-profile">
      ...
      <div class="profile-info">
        <img src="../../assets/teacher/teacher.png" alt="User Avatar" class="avatar" />
        <h2>{{ userData.data.user.username }}</h2>
        <p>毕业院校：{{ userData.data.teacherDetails.graduateIn }}</p>
        <p>教师号(teacherId)：{{ userData.data.teacherDetails.teacherId }}</p>
